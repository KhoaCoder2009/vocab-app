...
with new_set as (
  ...
  select null, 'IELTS Work & Jobs', 'Từ vựng về công việc - IELTS Speaking Part 1 & 2, Band 4.0-6.0.', 'medium', true, 'blue', 'IELTS Band 4.0-6.0', 'other', 'Work & Jobs', 'IELTS Band 4.0-6.0', 'Work & Jobs'
...
with new_set as (
  insert into public.vocabulary_sets (owner_id, title, description, difficulty, is_public, cover_color, category, category_id, topic)
  select null, 'IELTS Family', 'Từ vựng về gia đình - IELTS Speaking Part 1 & 2, Band 4.0-6.0.', 'easy', true, 'pink', 'IELTS Band 4.0-6.0', 'other', 'Family & Relationships'
...
with new_set as (
  insert into public.vocabulary_sets (owner_id, title, description, difficulty, is_public, cover_color, category, category_id, topic)
  select null, 'IELTS Hobbies', 'Từ vựng về sở thích - IELTS Speaking Part 1, Band 4.0-6.0.', 'easy', true, 'orange', 'IELTS Band 4.0-6.0', 'other', 'Hobbies'
...
with new_set as (
  insert into public.vocabulary_sets (owner_id, title, description, difficulty, is_public, cover_color, category, category_id, topic)
  select null, 'IELTS Shopping', 'Từ vựng về mua sắm - IELTS Speaking Part 1 & 3, Band 4.0-6.0.', 'easy', true, 'purple', 'IELTS Band 4.0-6.0', 'other', 'Shopping & Fashion'
...
with new_set as (
  insert into public.vocabulary_sets (owner_id, title, description, difficulty, is_public, cover_color, category, category_id, topic)
  select null, 'IELTS Transport', 'Từ vựng về giao thông vận tải - IELTS Speaking & Writing, Band 4.0-6.0.', 'medium', true, 'red', 'IELTS Band 4.0-6.0', 'other', 'Transportation'
...
with new_set as (
  insert into public.vocabulary_sets (owner_id, title, description, difficulty, is_public, cover_color, category, category_id, topic)
  select null, 'IELTS Home & Accommodation', 'Từ vựng về nhà ở - IELTS Speaking Part 1, Band 4.0-6.0.', 'easy', true, 'brown', 'IELTS Band 4.0-6.0', 'other', 'Home & Accommodation'
...
with new_set as (
  insert into public.vocabulary_sets (owner_id, title, description, difficulty, is_public, cover_color, category, category_id, topic)
  select null, 'IELTS Cities & Urban Life', 'Từ vựng về thành phố - IELTS Writing Task 2, Band 4.0-6.0.', 'medium', true, 'gray', 'IELTS Band 4.0-6.0', 'other', 'Cities & Urban Life'
...
with new_set as (
  insert into public.vocabulary_sets (owner_id, title, description, difficulty, is_public, cover_color, category, category_id, topic)
  select null, 'IELTS Internet & Social Media', 'Từ vựng về Internet và mạng xã hội - IELTS Speaking & Writing, Band 4.0-6.0.', 'medium', true, 'cyan', 'IELTS Band 4.0-6.0', 'other', 'Media & Communication'
...
with new_set as (
  insert into public.vocabulary_sets (owner_id, title, description, difficulty, is_public, cover_color, category, category_id, topic)
  select null, 'IELTS Sports & Exercise', 'Từ vựng về thể thao - IELTS Speaking Part 1 & 3, Band 4.0-6.0.', 'easy', true, 'green', 'IELTS Band 4.0-6.0', 'other', 'Sports & Hobbies'
...
with new_set as (
  insert into public.vocabulary_sets (owner_id, title, description, difficulty, is_public, cover_color, category, category_id, topic)
  select null, 'IELTS Books & Reading', 'Từ vựng về sách và đọc - IELTS Speaking Part 1, Band 4.0-6.0.', 'easy', true, 'brown', 'IELTS Band 4.0-6.0', 'other', 'Books & Reading'
