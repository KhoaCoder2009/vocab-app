  ...
  ({ className, state = 'idle', ...props }, ref) => {
    return (
      <input
        ref={ref}
        className={cn(
          'h-14 w-full rounded-xl border-2 bg-white px-4 text-center font-display text-xl font-semibold text-ink outline-none transition-colors dark:bg-slate-800 dark:text-white',
